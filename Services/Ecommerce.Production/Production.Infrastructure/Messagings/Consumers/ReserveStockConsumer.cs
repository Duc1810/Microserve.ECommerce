...
public class ReserveStockConsumer : IConsumer<CreatedEvent>
{
    ...
    public ReserveStockConsumer(IUnitOfWork unitOfRepository, IVersionStore redisVersionService, ILogger<ReserveStockConsumer> logger)
    {
